...
\section{Sensor Fusion and Non-linear Filtering}
...
\end{equation}
where $C(\theta, a)$ is a cost function and $a$ is a decision. Different cost functions can be chosen depdending on what we want to minmize. 
